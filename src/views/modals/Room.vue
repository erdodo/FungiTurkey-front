<template>
  <el-dialog v-model="state" title="Odanız" width="400px" :before-close="handleClose">
    <div>
    ...
    <template #footer>
      <span class="dialog-footer">
        <el-button type="" @click="$emit('success'), (state = false)">Kapat</el-button>
      </span>
    </template>
  </el-dialog>
</template>
  ...
  watch: {
    dialogVisible() {
      if (this.dialogVisible == true) {
        ...
        axios.post(this.fungi + "/ActivityRoom/" + this.room + "/get").then((res) => {
